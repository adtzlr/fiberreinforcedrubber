...
img = plotter.screenshot("results/test_specimen_deformed_fibre-range-max.png", scale=2)
...
plotter.add_axes(label_size=(0.06, 0.06))
img = plotter.screenshot("results/test_specimen_deformed_fibre-difference.png", scale=2)
